const formSignup = (function() {
  ...
  module._children = () => {
    ...
    const $inputFormUser = inputForm.render("Username", "username");

    const $labelFormEmail = labelForm.render("E-mail");
    const $inputFormEmail = inputForm.render("email", "example@teste.com");
    ...
    const $inputFormRepassword = inputForm.render("password", "******");
